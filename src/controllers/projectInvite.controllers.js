...
const resendProjectInvitation = asyncHandler(async (req, res) => {
  ...
  if (
    !userRole ||
    ![UserRolesEnum.ADMIN, UserRolesEnum.PROJECT_ADMIN].includes(userRole.role)
  ) {
    throw new ApiError(
      403,
      "You do not have permission to resend invitations for this project",
    );
  }
...
const cancelProjectInvitation = asyncHandler(async (req, res) => {
  ...
  if (
    ...
    throw new ApiError(
      403,
      "You do not have permission to cancel invitations for this project",
    );
  }
