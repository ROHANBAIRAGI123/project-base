...
import { successResponseSchema } from "../validators/response.schemas.js";
...
router.route("/accept/:invitationToken").get(acceptProjectInvitation);

// Reject invitation via email link (public - token based)
router.route("/reject/:invitationToken").get(rejectProjectInvitation);
...
router.route("/user/pending").get(verifyJWT, getUserPendingInvitations);

// Resend invitation email
router
  .route("/:invitationId/resend")
  .post(validate(mongoIdParamSchema), verifyJWT, resendProjectInvitation);

// Cancel a pending invitation
router
  .route("/:invitationId/cancel")
  .delete(validate(mongoIdParamSchema), verifyJWT, cancelProjectInvitation);
