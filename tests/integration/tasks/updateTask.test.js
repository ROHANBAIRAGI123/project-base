...
describe('PUT /api/v1/:projectId/tasks/:taskId — Update Task', () => {
    ...
    test.todo('should update task status from todo → in_progress → done correctly');

    test.todo('should return 400 when status value is not one of: todo, in_progress, done');
});
