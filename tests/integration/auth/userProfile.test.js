...
describe("GET /api/v1/auth/me", () => {
  it.todo(
    "should return 200 with the authenticated user object (excluding sensitive fields)",
  );

  it.todo("should return 401 when request is made without authentication");

  it.todo(
    "should NOT expose password, refreshToken, or forgotPasswordToken in the response",
  );
});
...
describe("PATCH /api/v1/auth/me", () => {
  it.todo(
    "should return 200 and update username when a valid username is provided",
  );

  it.todo(
    "should return 200 and update fullname when a valid fullname is provided",
  );

  it.todo(
    "should return 200 when only one of username or fullname is provided (partial update)",
  );

  it.todo(
    "should return 409 when the new username is already taken by another user",
  );
...
describe("POST /api/v1/auth/delete-user", () => {
  it.todo(
    "should return 200 and delete the account when the correct password is provided",
  );
...
describe("GET /api/v1/auth/get-all-users", () => {
  ...
  it.todo(
    "should NOT expose password, refreshToken, or other sensitive fields in the user list",
  );
});
